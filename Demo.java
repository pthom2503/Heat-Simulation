...
final static int COUNT = 5000;	
	...
	public static void main(String[] args) {
		...
		//all vars currently constant for testing
		double top = 100;
		double bot = 0;
		double left = 75;
		double right = 50;		
	...
	//takes the double 2d arrays old and new and iterates through the temperature change
	...
	//takes the 2D double array plate and double values and returns the 2D array
	//with edge values in place
	public static double[][] initialize(double[][] plate, double top, double bot, double left,
			double right){
	...
	//takes the number of runs completed and returns true if equal to the number of runs wanted
	...
	//takes 2 double arrays and replaces the value of "old" with the current values in "new"
